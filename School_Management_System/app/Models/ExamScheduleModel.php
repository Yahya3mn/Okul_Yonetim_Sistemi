...
class ExamScheduleModel extends Model
{
    ...
    {
        return self::select('exam_schedule.*', 'exam.name as exam_name')->join('exam', 'exam.id','=','exam_schedule.exam_id')
        ->where('exam_schedule.class_id','=',$class_id)->groupBy('exam_schedule.exam_id')->orderBy('exam_schedule.id','desc')->get();
    }
    ...
    {
        return MarkRegisterModel::CheckAlreadyMark($student_id,$class_id,$exam_id,$subject_id);
    }
}
