...
class ClassTimeTableController extends Controller
{
    ...
    public function get_subject(Request $request)
    {
        ...
        foreach ($getSubject as $value) {
            $html .= '<option value="'.$value->subjetc_id.'">'.$value->subject_name.'</option>';
        }
        $json['html'] = $html;
    ...
    public function MyTimetable(Request $request)
    {
        ...
        return view('ogrenci.my_timetable',$data);
    }
    ...
    public function MyTimetableTeacher($class_id, $subject_id)
    {
        ...
        $data['getRecord'] = $result;
        $data['header_title'] = "My Timetable";
        return view('ogretmen.my_timetable',$data);
    }
    ...
    public function MyTimetableParent($class_id, $subject_id, $student_id){
        ...
        $data['getRecord'] = $result;
        $data['header_title'] = "Student Timetable";
        return view('veli.student_timetable',$data);
    }
