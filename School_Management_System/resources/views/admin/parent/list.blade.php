              ...
              <form method="get" action="">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control" value="{{Request::get('occupation')}}" name="occupation"  placeholder="Ocuppation">
                  </div>
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <a href="{{url('admin/parent/list')}}" class="btn btn-success" style="margin-top: 31px;">Reset</a>
                  </div>
                      ...
                      @foreach ($getRecord as $value)
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="{{url('admin/parent/parents_student/' . $value->id)}}" class="btn btn-primary btn-sm">Parents Student</a>
                            </td>
