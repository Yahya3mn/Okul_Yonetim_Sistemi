                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                             ...
                             <div class="form-group col-md-2">
                                ...
                                <input type="text" name="student_name" class="form-control"  value="{{ Request::get('student_name') }}" placeholder="Student Name">
                             </div>
                           ...
                           <div class="form-group col-md-2">
                            ...
                            <input type="date" name="attendance_date" class="form-control"  value="{{ Request::get('attendance_date') }}" >
                         </div> 
                         ...
                         <div class="form-group col-md-2">
                           ...
                           <div class="form-group col-md-2">
                              ...
                              <a href="{{url('admin/attendance/report')}}" class="btn btn-success" style="margin-top: 31px;">Reset</a>
                           </div>
                        </div>
                     </div>
                  </form>
