            ...
            <form method="get" action="">
              ...
              <div class="card-body">
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="date" class="form-control" value="{{Request::get('date_of_joining')}}" name="date_of_joining"  placeholder="Date Of Joining">
                  </div>
