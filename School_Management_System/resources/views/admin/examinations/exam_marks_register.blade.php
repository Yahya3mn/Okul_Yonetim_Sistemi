                        ...
                        <tbody>
                           ...
                           <form action="POST" action="{{ url('admin/examinations/submit_marks_register') }}" class="SubmitForm">
                               ...
                               <tr>
                                   ...
                                   // Eğer $getMark null ise, varsayılan değer olarak 0 atıyoruz
                                   $class_work = !empty($getMark) ? $getMark->class_work : 0;
                                   $home_work = !empty($getMark) ? $getMark->home_work : 0;
                                   $exam_mark = !empty($getMark) ? $getMark->exam_mark : 0;
                                   $totalMark = $class_work * 0.2 + $home_work * 0.2 + $exam_mark * 0.6;
                                   ...
                                   <td>
                                       <div style="margin-bottom: 10px;">
                                           ...
                                           <input type="text" value="{{ $class_work }}" name="mark[{{$i}}][class_work]" 
                                       ...
                                       <div style="margin-bottom: 10px;">
                                           Home Work
                                           <input type="hidden" name="mark[{{$i}}][subject_id]" value="{{$subject->subject_id}}">
                                           <input type="text" value="{{ $home_work }}" name="mark[{{$i}}][home_work]" 
                                       ...
                                       <div style="margin-bottom: 10px;">
                                           Final Mark
                                           <input type="hidden" name="mark[{{$i}}][subject_id]" value="{{$subject->subject_id}}">
                                           <input type="text" value="{{ $exam_mark }}" name="mark[{{$i}}][exam_mark]" 
...
<script type="text/javascript">
    ...
    $('.SaveSingleSubject').click(function(e){
      ...
      $.ajax({
            type: "POST",
            url : "{{ url('admin/examinations/submit_single_marks_register') }}",
            data: {
               "_token" : "{{ csrf_token() }}",
               id : id,
