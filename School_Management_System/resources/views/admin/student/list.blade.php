          ...
          <div class="col-md-12">
            ...
            <form method="get" action="">
              ...
              <div class="card-body">
                ...
                <div class="form-group col-md-2">
                  <label>Caste</label>
                  <input type="text" class="form-control" value="{{Request::get('caste')}}" name="class_name"  placeholder="Caste">
                </div>

                <div class="form-group col-md-2">
                  <label>Religion</label>
                  <input type="text" class="form-control" value="{{Request::get('religion')}}" name="class_name"  placeholder="Religion">
                </div>
                ...
                <div class="form-group col-md-2">
                  <label>Height</label>
                  <input type="text" class="form-control" value="{{Request::get('height')}}" name="height"  placeholder="Height">
                </div>

                <div class="form-group col-md-2">
                  <label>Weight</label>
                  <input type="text" class="form-control" value="{{Request::get('weight')}}" name="weight"  placeholder="Weight">
                </div>
