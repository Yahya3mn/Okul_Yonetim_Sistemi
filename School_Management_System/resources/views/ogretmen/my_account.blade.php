                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea class="form-control"  name="address" placeholder="Current Address">{{old('address',$getRecord->address)}}</textarea>
                            <div style="color:red"> {{ $errors->first('address') }} </div>
                        </div>

                        <div class="form-group col-md-6">
                            <label>Perminant Address <span style="color: red;">*</span></label>
                            <textarea class="form-control"  name="perminant_address"  placeholder="Perminant Address">{{old('perminant_address',$getRecord->perminant_address)}}</textarea>
